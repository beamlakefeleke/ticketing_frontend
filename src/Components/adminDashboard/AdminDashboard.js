...
const AdminDashboard = () => {
    ...
    const fetchUsers = async () => {
        ...
        try {
            const response = await axios.get('https://ticketing-backend-git-main-beamlakefelekes-projects.vercel.app/api/users', {
    ...
    const handleUpdateStatus = async (id, status) => {
        try {
            const token = localStorage.getItem('token');
            await axios.put(`https://ticketing-backend-git-main-beamlakefelekes-projects.vercel.app/api/tickets/${id}`, { status }, {
                headers: { Authorization: `Bearer ${token}` },
            });
            dispatch(fetchAllTickets());
        } catch (error) {
    ...
    const handleUpdateUser = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.put(`https://ticketing-backend-git-main-beamlakefelekes-projects.vercel.app/api/users/${updatingUserId}`, {
    ...
    const handleDeleteUser = async (userId) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`https://ticketing-backend-git-main-beamlakefelekes-projects.vercel.app/api/users/${userId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
